...
Bookmark.create(
  comment: 'Superhero movie revisited',
  movie_id: 2,
  list_id: 1
)

Bookmark.create(
  comment: "Spielberg's movie",
  movie_id: 3,
  list_id: 1
)
...
#   overview: 'Wonder Woman comes into conflict with the Soviet Union during
...
# Movie.create(
#   title: "Ocean's Eight",
#   overview: 'Debbie Ocean, a criminal mastermind, gathers a crew of female
#   thieves to pull off the heist of the century.',
